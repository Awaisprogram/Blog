        ...
        <div className="mt-10 lg:w-8/12 w-full slide-left"> 
          ...
          <div className="flex items-center mt-8">
            <input
              ...
              className="border border-gray-300 rounded-l-full lg:px-16 px-3 py-3 outline-none"
            />
            <button className="bg-color lg:px-6 px-4 py-3 text-white font-bold rounded-r-full hover:bg-hover transition duration-300 ease-in">
              Subscribe
            </button>
          </div>
        </div>
